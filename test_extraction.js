// Test script for detailed profile extraction
...
async function testExtraction() {
    try {
        console.log('Testing detailed profile extraction...\n');
        
        const response = await fetch('http://localhost:3001/api/extract-detailed-profile', {
            method: 'POST',
            headers: {
